(function(){
  ...
  if (statEl && 'IntersectionObserver' in window){
    ...
    // $15,400: average U.S. homeowners insurance claim for water damage, 2026.
  ...
  // -- Sticky mobile CTA bar: only meaningful <=820px, hidden while the real CTA panel is in view --
  var stickyCta = document.getElementById('stickyCta');
  var ctaPanel = document.querySelector('.cta-section');
  function mobileCheck(){ return window.matchMedia('(max-width: 820px)').matches; }
