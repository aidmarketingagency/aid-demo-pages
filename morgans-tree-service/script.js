(function(){
  ...
  if (statEl && 'IntersectionObserver' in window){
    ...
    // $5,000: high end for an emergency, storm-night tree removal in 2026.
    // Source: https://homecostlab.com/guides/tree-removal-cost-guide/ (see THE MATH comment block)
    var STAT_TARGET = 5000;
    var countRun = 0;
