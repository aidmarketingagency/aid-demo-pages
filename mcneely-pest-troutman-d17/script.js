...
const bubbles = [
  ...
  {el:document.getElementById('b3'),typing:null,delay:3600},
  {el:document.getElementById('b4'),typing:document.getElementById('typing2'),delay:5200},
];
