(function(){
  ...
  if (statEl && 'IntersectionObserver' in window){
    ...
    // $4,000: high end to clear a large pine off a structure after hours.
    // Source: https://stumpoff.com/emergency-tree-removal-cost/ (see THE MATH comment block)
    var STAT_TARGET = 4000;
    var countRun = 0;
