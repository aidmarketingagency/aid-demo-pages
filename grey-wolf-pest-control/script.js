(function(){
  ...
  // The reduced-motion fallback must cover JS-driven animation, not just CSS.
  ...
  function playThread(){
    ...
    var seq = [
      ...
      { t: 5400, action: function(){ bubbles[5].classList.add('show'); playing = false; } }
    ];
  ...
  if (statEl && 'IntersectionObserver' in window){
    ...
    // $1,800: top of the published $850-$1,800 Charlotte metro liquid barrier termite
    // treatment range. Source: https://pestcontrolpricing.com/termite-treatment-cost-charlotte/
    // (see THE MATH comment block above for the full source list).
